"""
Django settings for skill_it project.
...
SECRET_KEY = '65bf31fe8fbb92f4838f6c491f1effb279846e33c607fae1'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['skillitapp.herokuapp.com']
...
ROOT_URLCONF = 'skill_it.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['C:/Users/Vlada/Documents/GitHub/skill-it/general/templates/'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'skill_it.wsgi.application'
